# Django settings for sdulife project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sdulife.sql',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'odj+n22@#mygm!bp$un(((7)l%q%opzz$x1bvej^sqymf*9vr0'
